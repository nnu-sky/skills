...
The categories below are workflow guidance, not a verbatim or universal journal policy. Verify the current target venue policy when submission or disclosure requirements are relevant. Evidence-grounded drafting is allowed within the user’s authorized task; human authors retain responsibility for interpretation and verification.
...
- substitute unverified AI conclusions for author judgment or present unsupported arguments as established evidence
