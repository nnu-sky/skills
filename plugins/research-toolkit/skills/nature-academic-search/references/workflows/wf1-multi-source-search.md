...
**Sources:** Use available MCP tools or the documented web/API fallback.
...
2. **Select sources by tier** — follow [Source Tiers](../source-tiers.md). Honor user-specified databases and select available sources suited to the task. Use tiers as a default source-quality guide, not a mandatory escalation sequence.
