...
The names below describe optional tool capabilities. First inspect the currently callable tools; unavailable names are not required calls. Use the no-MCP fallback when appropriate, and do not install services merely to match this inventory.
