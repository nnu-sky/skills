...
> **Version notice:** This file is a historical checklist snapshot. Before submission, verify every venue-specific requirement, page limit, disclosure rule, and style package against the current official author guide for the target year.
...
**For systems conference checklists (OSDI, NSDI, ASPLOS, SOSP)**, see the [systems-paper-writing](https://github.com/Orchestra-Research/AI-Research-SKILLs/tree/main/20-ml-paper-writing) skill.
...
**Systems conference templates** (OSDI, NSDI, ASPLOS, SOSP) are in the [systems-paper-writing](https://github.com/Orchestra-Research/AI-Research-SKILLs/tree/main/20-ml-paper-writing) skill.
