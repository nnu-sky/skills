...
> **Version notice:** Scales, forms, dates, and policies change. Use this file for reviewer-facing reasoning patterns, then verify current venue-specific instructions on the official site.
...
**For systems conference reviewer guidelines (OSDI, NSDI, ASPLOS, SOSP)**, see the [systems-paper-writing](https://github.com/Orchestra-Research/AI-Research-SKILLs/tree/main/20-ml-paper-writing) skill.
