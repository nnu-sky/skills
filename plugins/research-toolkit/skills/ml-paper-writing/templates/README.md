...
This directory contains historical LaTeX template snapshots for major ML/AI conferences. Obtain the current official package for the target venue/year before submission. Standard packages such as natbib are supplied by your TeX distribution, not bundled here.

**Systems conference templates** (OSDI, NSDI, ASPLOS, SOSP) have moved to the [systems-paper-writing](https://github.com/Orchestra-Research/AI-Research-SKILLs/tree/main/20-ml-paper-writing) skill.
...
Systems conference templates (OSDI, NSDI, ASPLOS, SOSP) are now in the [systems-paper-writing](https://github.com/Orchestra-Research/AI-Research-SKILLs/tree/main/20-ml-paper-writing) skill.
...
**Systems conferences** (OSDI, NSDI, ASPLOS, SOSP): See the [systems-paper-writing](https://github.com/Orchestra-Research/AI-Research-SKILLs/tree/main/20-ml-paper-writing) skill for page limits and templates.
...
**Systems:** See the [systems-paper-writing](https://github.com/Orchestra-Research/AI-Research-SKILLs/tree/main/20-ml-paper-writing) skill for OSDI, NSDI, ASPLOS, SOSP template sources
