...
Keep private paths and unrelated identifying details out of public-facing manuscripts and figures. Within the owner's task, link deliverables and provide relevant source paths or attribution when needed to explain an adaptation or answer a source question. Honor the user's publication scope and preserve required third-party attribution.

## Privacy rules

- Use neutral paths and self-contained code for public deliverables.
- Do not publish private templates or identifying labels merely because they were available for internal reference.
- Explain material source provenance honestly; do not conceal it when the owner asks.
...
Keep unrelated private paths out of public artifacts; use relevant file links when reporting to the owner.
